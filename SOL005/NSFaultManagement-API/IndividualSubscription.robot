...
Post Individual Subscription - Method not implemented
    ...
    ...    Pre-conditions:none 
    ...    Reference: clause 8.4.5.3.1 - SOL005 v2.4.1
...
Get Information about an individual subscription
    ...
    ...    Reference: clause 8.4.5.3.2 - SOL005 v2.4.1
    ...    Config ID: Config_prod_NFVO
    ...    Applicability:  none
...
PUT an individual subscription - Method not implemented
    ...
    ...    Pre-conditions: none
    ...    Reference: clause 8.4.5.3.3 - SOL005 v2.4.1
    ...    Config ID: Config_prod_NFVO
    ...    Applicability: none
    ...    Post-Conditions: none
...
PATCH an individual subscription - Method not implemented
    ...
    ...    Pre-conditions: none
    ...    Reference: clause 8.4.5.3.4 - SOL005 v2.4.1
    ...    Config ID: Config_prod_NFVO
    ...    Applicability: none
    ...    Post-Conditions: none
...
DELETE an individual subscription
    ...
    ...    Reference: clause 8.4.5.3.5 - SOL005 v2.4.1
    ...    Config ID: Config_prod_NFVO
    ...    Applicability:  none
