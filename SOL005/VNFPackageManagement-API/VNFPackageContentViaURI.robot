...
Upload VNF Package Content from URI
    ...
    ...    Reference: clause 9.4.6.3.1 - ETSI GS NFV-SOL 005 [3] v2.6.1
...
GET Individual VNF Package Content from URI - Method not implemented
    ...
    ...    Reference: clause 9.4.6.3.2 - ETSI GS NFV-SOL 005 [3] v2.6.1
    ...    Config ID: Config_prod_NFVO
    ...    Applicability: none
    ...    Post-Conditions: none
...
PUT Individual VNF Package Content from URI - Method not implemented
    ...
    ...    Pre-conditions: One or more VNF packages are onboarded in the NFVO.
    ...    Reference: clause 9.4.6.3.3 - ETSI GS NFV-SOL 005 [3] v2.6.1
    ...    Config ID: Config_prod_NFVO
    ...    Applicability: none
    ...    Post-Conditions: none
...
PATCH Individual VNF Package Content from URI - Method not implemented
    ...
    ...    Pre-conditions: One or more VNF packages are onboarded in the NFVO.
    ...    Reference: clause 9.4.6.3.4 - ETSI GS NFV-SOL 005 [3] v2.6.1
    ...    Config ID: Config_prod_NFVO
    ...    Applicability: none
    ...    Post-Conditions: none
...
DELETE Individual VNF Package Content from URI - Method not implemented
    ...
    ...    Pre-conditions: One or more VNF packages are onboarded in the NFVO.
    ...    Reference: clause 9.4.6.3.5 - ETSI GS NFV-SOL 005 [3] v2.6.1
    ...    Config ID: Config_prod_NFVO
    ...    Applicability: none
