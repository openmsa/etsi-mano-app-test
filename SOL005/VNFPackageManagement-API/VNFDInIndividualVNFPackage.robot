...
Get single file VNFD in Individual VNF Package in Plain Format
    ...
    ...    Reference: clause 9.4.4.3.2 - ETSI GS NFV-SOL 005 [3] v2.4.1
...
POST VNFD in Individual VNF Package - Method not implemented
    ...
    ...    Pre-conditions: none
    ...    Reference: clause 9.4.4.3.1 - ETSI GS NFV-SOL 005 [3] v2.4.1
    ...    Config ID: Config_prod_NFVO
    ...    Applicability: none
    ...    Post-Conditions: none
...
PUT VNFD in Individual VNF Package - Method not implemented
    ...
    ...    Pre-conditions: One or more VNF packages are onboarded in the NFVO.
    ...    Reference: clause 9.4.4.3.3 - ETSI GS NFV-SOL 005 [3] v2.4.1
    ...    Config ID: Config_prod_NFVO
    ...    Applicability: none
    ...    Post-Conditions: none
...
PATCH VNFD in Individual VNF Package - Method not implemented
    ...
    ...    Pre-conditions: One or more VNF packages are onboarded in the NFVO.
    ...    Reference: clause 9.4.4.3.4 - ETSI GS NFV-SOL 005 [3] v2.4.1
    ...    Config ID: Config_prod_NFVO
    ...    Applicability: none
    ...    Post-Conditions: none
...
DELETE VNFD in Individual VNF Package - Method not implemented
    ...
    ...    Pre-conditions: One or more VNF packages are onboarded in the NFVO.
    ...    Reference: clause 9.4.4.3.5 - ETSI GS NFV-SOL 005 [3] v2.4.1
    ...    Config ID: Config_prod_NFVO
    ...    Applicability: none
