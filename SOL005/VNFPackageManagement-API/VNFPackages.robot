...
GET all VNF Packages
    ...
    ...    Reference: clause 9.4.2.3.2 - SOL005 v2.4.1
...
Get all VNF Packages with malformed authorization token
    ...
    ...    Pre-conditions: One or more VNF Packages are onboarded in the NFVO.
    ...    Reference: clause 4.5.3.3, 9.4.2.3.2 - SOL005 v2.4.1
    ...    Config ID: Config_prod_NFVO
...
GET VNF Packages with "all_fields" attribute selector
    ...
    ...    Pre-conditions: One or more VNF packages are onboarded in the NFVO.
    ...    Reference: clause 4.3.3.2.1, 9.4.2.3.2 - SOL005 v2.4.1
    ...    Config ID: Config_prod_NFVO
    ...    Applicability: none
    ...    Post-Conditions: none    
    GET VNF Packages with all_fields attribute selector
...
Create new VNF Package Resource
    ...
    ...    Pre-conditions: none
    ...    Reference: clause 9.4.2.3.1 - SOL005 v2.4.1
    ...    Config ID: Config_prod_NFVO
    ...    Applicability: none
...
PUT all VNF Packages - Method not implemented
    ...
    ...    Pre-conditions: One or more VNF packages are onboarded in the NFVO.
    ...    Reference: clause 9.4.2.3.3 - SOL005 v2.4.1
    ...    Config ID: Config_prod_NFVO
    ...    Applicability: none
    ...    Post-Conditions: none
...
PATCH all VNF Packages - Method not implemented
    ...
    ...    Pre-conditions: One or more VNF packages are onboarded in the NFVO.
    ...    Reference: clause 9.4.2.3.4 - SOL005 v2.4.1
    ...    Config ID: Config_prod_NFVO
    ...    Applicability: none
    ...    Post-Conditions: none
...
DELETE all VNF Packages - Method not implemented
    ...
    ...    Pre-conditions: One or more VNF packages are onboarded in the NFVO.
    ...    Reference: clause 9.4.2.3.5 - SOL005 v2.4.1
    ...    Config ID: Config_prod_NFVO
    ...    Applicability: none
