...
GET Individual Network Service Descriptor Information
    ...
    ...    Reference: clause 5.4.3.3.2 - SOL005 v2.4.1
...
Disable Individual Network Service Descriptor   
    ...
    ...    Reference: clause 5.4.3.3.4 - SOL005 v2.4.1
    ...    Config ID: Config_prod_NFVO
    ...    Applicability: none
...
DELETE Individual Network Service Descriptor
    ...
    ...    Reference: clause 5.4.3.3.5 - SOL005 v2.4.1
    ...    Config ID: Config_prod_NFVO
    ...    Applicability: none
...
POST Individual Network Service Descriptor - Method not implemented
    ...
    ...    Pre-conditions: none
    ...    Reference: clause 5.4.3.3.1 - SOL005 v2.4.1
    ...    Config ID: Config_prod_NFVO
    ...    Applicability: none
    ...    Post-Conditions: none
...
PUT Individual Network Service Descriptor - Method not implemented
    ...
    ...    Pre-conditions: none
    ...    Reference: clause 5.4.3.3.3 - SOL005 v2.4.1
    ...    Config ID: Config_prod_NFVO
    ...    Applicability: none
    ...    Post-Conditions: none
