...
GET Individual Network Service Descriptor Information
    ...
    ...    Reference: clause 5.4.3.3.2 - ETSI GS NFV-SOL 005 [3] v2.4.1
...
DELETE Individual Network Service Descriptor
    ...
    ...    Reference: clause 5.4.3.3.5 - ETSI GS NFV-SOL 005 [3] v2.4.1
    ...    Config ID: Config_prod_NFVO
    ...    Applicability: none
...
POST Individual Network Service Descriptor - Method not implemented
    ...
    ...    Pre-conditions: none
    ...    Reference: clause 5.4.3.3.1 - ETSI GS NFV-SOL 005 [3] v2.4.1
    ...    Config ID: Config_prod_NFVO
    ...    Applicability: none
    ...    Post-Conditions: none
...
PUT Individual Network Service Descriptor - Method not implemented
    ...
    ...    Pre-conditions: none
    ...    Reference: clause 5.4.3.3.3 - ETSI GS NFV-SOL 005 [3] v2.4.1
    ...    Config ID: Config_prod_NFVO
    ...    Applicability: none
    ...    Post-Conditions: none
