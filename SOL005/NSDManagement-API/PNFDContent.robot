...
Get PNFD Content
    ...
    ...    Reference: clause 5.4.7.3.2 - ETSI GS NFV-SOL 005 [3] v2.6.1
...
Upload PNFD Content as plain text file
    ...
    ...    Pre-conditions: One or more PNFDs are onboarded in the NFVO.
    ...    Reference: clause 5.4.7.3.4 - ETSI GS NFV-SOL 005 [3] v2.6.1
    ...    Config ID: Config_prod_NFVO
    ...    Applicability: none
...
POST PNFD Content - Method not implemented
    ...
    ...    Pre-conditions: none
    ...    Reference: clause 5.4.7.3.1 - ETSI GS NFV-SOL 005 [3] v2.6.1
    ...    Config ID: Config_prod_NFVO
    ...    Applicability: none
    ...    Post-Conditions: none
...
DELETE PNFD Content - Method not implemented
    ...
    ...    Pre-conditions: none
    ...    Reference: clause 5.4.7.3.5 - ETSI GS NFV-SOL 005 [3] v2.6.1
    ...    Config ID: Config_prod_NFVO
    ...    Applicability: none
