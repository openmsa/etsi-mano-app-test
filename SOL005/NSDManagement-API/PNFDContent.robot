...
Get PNFD Content
    ...
    ...    Reference: clause 5.4.7.3.2 - SOL005 v2.4.1
...
Upload PNFD Content as plain text file
    ...
    ...    Pre-conditions: One or more PNFDs are onboarded in the NFVO.
    ...    Reference: clause 5.4.7.3.4 - SOL005 v2.4.1
    ...    Config ID: Config_prod_NFVO
    ...    Applicability: none
...
POST PNFD Content - Method not implemented
    ...
    ...    Pre-conditions: none
    ...    Reference: clause 5.4.7.3.1 - SOL005 v2.4.1
    ...    Config ID: Config_prod_NFVO
    ...    Applicability: none
    ...    Post-Conditions: none
...
DELETE PNFD Content - Method not implemented
    ...
    ...    Pre-conditions: none
    ...    Reference: clause 5.4.7.3.5 - SOL005 v2.4.1
    ...    Config ID: Config_prod_NFVO
    ...    Applicability: none
