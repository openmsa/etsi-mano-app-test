...
GET all PNF Descriptors Information
    ...
    ...    Reference: clause 5.4.5.3.2 - SOL005 v2.4.1
...
GET all PNF Descriptors Information with "all_fields" attribute selector
    ...
    ...    Pre-conditions: One or more PNF Descriptors are onboarded in the NFVO.
    ...    Reference: clause 4.3.3.2.1, 5.4.5.3.2 - SOL005 v2.4.1
    ...    Config ID: Config_prod_NFVO
    ...    Applicability: none
    ...    Post-Conditions: none
    GET all PNF Descriptors Information with all_fields attribute selector
...
Create new PNF Descriptor Resource
    ...
    ...    Pre-conditions: none
    ...    Reference: clause 5.4.5.3.1 - SOL005 v2.4.1
    ...    Config ID: Config_prod_NFVO
    ...    Applicability: none
...
PUT all PNF Descriptors - Method not implemented
    ...
    ...    Pre-conditions: One or more PNF Descriptors are onboarded in the NFVO.
    ...    Reference: clause 5.4.5.3.3 - SOL005 v2.4.1
    ...    Config ID: Config_prod_NFVO
    ...    Applicability: none
    ...    Post-Conditions: none
...
PATCH all PNF Descriptors - Method not implemented
    ...
    ...    Pre-conditions: One or more PNF Descriptors are onboarded in the NFVO.
    ...    Reference: clause 5.4.5.3.4 - SOL005 v2.4.1
    ...    Config ID: Config_prod_NFVO
    ...    Applicability: none
    ...    Post-Conditions: none
...
DELETE all PNF Descriptors - Method not implemented
    ...
    ...    Pre-conditions: One or more PNF Descriptors are onboarded in the NFVO.
    ...    Reference: clause 5.4.5.3.5 - SOL005 v2.4.1
    ...    Config ID: Config_prod_NFVO
    ...    Applicability: none
