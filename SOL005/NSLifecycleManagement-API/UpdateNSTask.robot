...
GET Update NSInstance- Method not implemented
    ...
    ...    Pre-conditions: none
    ...    Reference: clause 6.4.6.3.2 - ETSI GS NFV-SOL 005 [3] v2.4.1
    ...    Config ID: Config_prod_NFVO
    ...    Applicability: none
...
PUT Update NSInstance - Method not implemented
    ...
    ...    Pre-conditions: none
    ...    Reference: clause 6.4.6.3.3 - ETSI GS NFV-SOL 005 [3] v2.4.1
    ...    Config ID: Config_prod_NFVO
    ...    Applicability: none
    ...    Post-Conditions: The  NS instance is not updated on the NFVO
...
PATCH Update NSInstance - Method not implemented
    ...
    ...    Pre-conditions: none
    ...    Reference: clause 6.4.6.3.4 - ETSI GS NFV-SOL 005 [3] v2.4.1
    ...    Config ID: Config_prod_NFVO
    ...    Applicability: none
    ...    Post-Conditions: The  NS instance is not updated on the NFVO
...
DELETE Update NSInstance - Method not implemented
    ...
    ...    Pre-conditions: none
    ...    Reference: clause 6.4.6.3.5 - ETSI GS NFV-SOL 005 [3] v2.4.1
    ...    Config ID: Config_prod_NFVO
    ...    Applicability: none
