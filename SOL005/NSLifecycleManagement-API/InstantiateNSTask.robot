...
POST Instantiate a nsInstance
    ...
    ...    Pre-conditions: none
    ...    Reference: clause 6.4.4.3.1 - SOL005 v2.4.1
...
GET Instantiate NSInstance - Method not implemented
    ...
    ...    Pre-conditions: none
    ...    Reference: clause 6.4.4.3.2 - SOL005 v2.4.1
    ...    Config ID: Config_prod_NFVO
    ...    Applicability: none
...
PUT Instantiate NSInstance - Method not implemented
    ...
    ...    Test objective: The objective is to test that the operation can't be performed due because method is not implemented
    ...    Pre-conditions: none
    ...    Reference: clause 6.4.4.3.3 - SOL005 v2.4.1
    ...    Config ID: Config_prod_NFVO
    ...    Applicability: none
    ...    Post-Conditions: none.
...
PATCH Instantiate NSInstance - Method not implemented
    ...
    ...    Test objective: The objective is to test that the operation can't be performed due because method is not implemented
    ...    Pre-conditions: none
    ...    Reference: clause 6.4.4.3.4 - SOL005 v2.4.1
    ...    Config ID: Config_prod_NFVO
    ...    Applicability: none
    ...    Post-Conditions: none.
...
DELETE Instantiate NSInstance - Method not implemented
    ...
    ...    Test objective: The objective is to test that the operation can't be performed due because method is not implemented
    ...    Pre-conditions: none
    ...    Reference: clause 6.4.4.3.5 - SOL005 v2.4.1
    ...    Config ID: Config_prod_NFVO
    ...    Applicability: none
    ...    Post-Conditions: none.
