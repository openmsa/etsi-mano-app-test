...
POST Cancel operation task
    ...
    ...    Reference: clause 6.4.15.3.1 - SOL005 v2.4.1
...
GET Cancel operation task - Method not implemented 
    ...
    ...    Pre-conditions: none
    ...    Reference: clause 6.4.15.3.2 - SOL005 v2.4.1
    ...    Config ID: Config_prod_NFVO
    ...    Applicability: none
    ...    Post-Conditions: none
...
PUT Cancel operation task - Method not implemented
    ...
    ...    Pre-conditions: none
    ...    Reference: clause 6.4.15.3.3 - SOL005 v2.4.1
    ...    Config ID: Config_prod_NFVO
    ...    Applicability: none
    ...    Post-Conditions: none    
...
PATCH Cancel operation task - Method not implemented
    ...
    ...    Pre-conditions: none
    ...    Reference: clause 6.4.15.3.4 - SOL005 v2.4.1
    ...    Config ID: Config_prod_NFVO
    ...    Applicability: none
    ...    Post-Conditions: none
...
DELETE Cancel operation task - Method not implemented
    ...
    ...    Pre-conditions: none
    ...    Reference: clause 6.4.15.3.5 - SOL005 v2.4.1
    ...    Config ID: Config_prod_NFVO
    ...    Applicability: none
    ...    Post-Conditions: none
