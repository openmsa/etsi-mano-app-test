...
POST Individual VNF Package Artifact - Method not implemented
    ...
    ...    Pre-conditions: none
    ...    Reference: clause 10.4.6.3.1 - ETSI GS NFV-SOL 003 [1] v2.6.1
    ...    Config ID: Config_prod_NFVO
    ...    Applicability: none
    ...    Post-Conditions: none
...
PUT Individual VNF Package Artifact - Method not implemented
    ...
    ...    Pre-conditions: One or more VNF packages are onboarded in the NFVO.
    ...    Reference: clause 10.4.6.3.3 - ETSI GS NFV-SOL 003 [1] v2.6.1
    ...    Config ID: Config_prod_NFVO
    ...    Applicability: none
    ...    Post-Conditions: none
...
PATCH Individual VNF Package Artifact - Method not implemented
    ...
    ...    Pre-conditions: One or more VNF packages are onboarded in the NFVO.
    ...    Reference: clause 10.4.6.3.4 - ETSI GS NFV-SOL 003 [1] v2.6.1
    ...    Config ID: Config_prod_NFVO
    ...    Applicability: none
    ...    Post-Conditions: none
...
DELETE Individual VNF Package Artifact - Method not implemented
    ...
    ...    Pre-conditions: One or more VNF packages are onboarded in the NFVO.
    ...    Reference: clause 10.4.6.3.5 - ETSI GS NFV-SOL 003 [1] v2.6.1
    ...    Config ID: Config_prod_NFVO
    ...    Applicability: none
...
GET Individual OnBoarded VNF Package Artifact in octet stream format
    [Documentation]    Test ID: 7.3.3.5.13
...
GET Individual OnBoarded VNF Package Artifact with Range Request and NFVO supporting Range Requests
    [Documentation]    Test ID: 7.3.3.5.14
...
GET Individual OnBoarded VNF Package Artifact with Range Request and NFVO not supporting Range Requests
    [Documentation]    Test ID: 7.3.3.5.15
...
GET Individual OnBoarded VNF Package Artifact with invalid Range Request
    [Documentation]    Test ID: 7.3.3.5.16
...
GET Individual OnBoarded VNF Package Artifact with invalid resource identifier
    [Documentation]    Test ID: 7.3.3.5.17
...
POST Individual OnBoarded VNF Package Artifact - Method not implemented
    [Documentation]    Test ID: 7.3.3.5.19
...
PUT Individual OnBoarded VNF Package Artifact - Method not implemented
    [Documentation]    Test ID: 7.3.3.5.20
...
PATCH Individual OnBoarded VNF Package Artifact - Method not implemented
    [Documentation]    Test ID: 7.3.3.5.21
...
DELETE Individual OnBoarded VNF Package Artifact - Method not implemented
    [Documentation]    Test ID: 7.3.3.5.22
