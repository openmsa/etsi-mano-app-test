...
POST Scale a vnfInstance
    ...
    ...    Pre-conditions: none
    ...    Reference: clause 5.4.5.3.1 - SOL003 v2.4.1
...
GET Scale VNFInstance - Method not implemented
    ...
    ...    Pre-conditions:  
    ...    Reference: clause 5.4.5.3.2 - SOL003 v2.4.1
    ...    Config ID: Config_prod_VNFM
    ...    Applicability: 
    ...    Post-Conditions: 
...
PUT Scale VNFInstance - Method not implemented
    ...
    ...    Test objective: The objective is to verify that the method is not implemented
    ...    Pre-conditions:  
    ...    Reference: clause 5.4.5.3.3 - SOL003 v2.4.1
    ...    Config ID: Config_prod_VNFM
    ...    Applicability: 
    ...    Post-Conditions: 
...
PATCH Scale VNFInstance - Method not implemented
    ...
    ...    Test objective: The objective is to verify that the method is not implemented
    ...    Pre-conditions:  
    ...    Reference: clause 5.4.5.3.4 - SOL003 v2.4.1
    ...    Config ID: Config_prod_VNFM
    ...    Applicability: 
    ...    Post-Conditions: 
...
DELETE Scale VNFInstance - Method not implemented
    ...
    ...    Test objective: The objective is to verify that the method is not implemented
    ...    Pre-conditions:  
    ...    Reference: clause 5.4.5.3.5 - SOL003 v2.4.1
    ...    Config ID: Config_prod_VNFM
    ...    Applicability: 
    ...    Post-Conditions: 
