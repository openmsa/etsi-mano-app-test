...
Post Individual VNFInstance - Method not implemented
    ...
    ...    Pre-conditions: none
    ...    Reference: clause 5.4.3.3.1 - SOL003 v2.4.1
...
Get Information about an individual VNF Instance
    ...
    ...    Pre-conditions: none
    ...    Reference: clause 5.4.3.3.2 - SOL003 v2.4.1
    ...    Config ID: Config_prod_VNFM
    ...    Applicability: 
    ...    Post-Conditions: 
...
PUT Individual VNFInstance - Method not implemented 
    ...
    ...    Pre-conditions: none
    ...    Reference: clause 5.4.3.3.3 - SOL003 v2.4.1
    ...    Config ID: Config_prod_VNFM
    ...    Applicability: 
    ...    Post-Conditions: 
...
PATCH Individual VNFInstance
    ...
    ...    Reference: clause 5.4.3.3.4 - SOL003 v2.4.1
    ...    Config ID: Config_prod_VNFM
    ...    Applicability: 
...
DELETE Individual VNFInstance
    ...
    ...    Reference: clause 5.4.3.3.5 - SOL003 v2.4.1
    ...    Config ID: Config_prod_VNFM
    ...    Applicability: 
