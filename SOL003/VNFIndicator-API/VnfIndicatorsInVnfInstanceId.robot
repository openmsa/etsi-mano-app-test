...
Get Indicators for VNF Instance
    ...
    ...    Reference: Clause 8.4.3.3.2 - ETSI GS NFV-SOL 003 [1] v2.6.1
...
POST Indicators for VNF instance - Method not implemented
    ...
    ...    Reference: Clause 8.4.3.3.1 - ETSI GS NFV-SOL 003 [1] v2.6.1
    ...    Config ID: Config_prod_VNFM
    ...    Applicability: none
    ...    Post-Conditions: none
...
PUT Indicators for VNF instance - Method not implemented
    ...
    ...    Pre-conditions: A VNF instance is instantiated. One or more measures of VNF indicators are available in the VNFM for the given VNF instance.
    ...    Reference: Clause 8.4.3.3.3 - ETSI GS NFV-SOL 003 [1] v2.6.1
    ...    Config ID: Config_prod_VNFM
    ...    Applicability: none
    ...    Post-Conditions: none
...
PATCH Indicators for VNF instance - Method not implemented
    ...
    ...    Pre-conditions: A VNF instance is instantiated. One or more measures of VNF indicators are available in the VNFM for the given VNF instance.
    ...    Reference: Clause 8.4.3.3.4 - ETSI GS NFV-SOL 003 [1] v2.6.1
    ...    Config ID: Config_prod_VNFM
    ...    Applicability: none
    ...    Post-Conditions: none
...
Get Indicators for VNF Instance as Paged Response
    [Documentation]    Test ID: 7.3.6.2.9
...
Get Indicators for VNF Instance - Bad Request Response too Big
    [Documentation]    Test ID: 7.3.6.2.10
