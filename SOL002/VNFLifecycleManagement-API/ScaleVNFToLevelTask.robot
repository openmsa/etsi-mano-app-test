...
POST Scale a vnfInstance to level
    ...
    ...    Pre-conditions: none
    ...    Reference: clause 5.4.6.3.1 - SOL002 v2.4.1
...
GET Scale to level VNFInstance - Method not implemented
    ...
    ...    Pre-conditions:  
    ...    Reference: clause 5.4.6.3.2 - SOL002 v2.4.1
    ...    Config ID: Config_prod_VE
    ...    Applicability: 
    ...    Post-Conditions: 
...
PUT Scale to level VNFInstance - Method not implemented
    ...
    ...    Test objective: The objective is to verify that the method is not implemented
    ...    Pre-conditions:  
    ...    Reference: clause 5.4.6.3.3 - SOL002 v2.4.1
    ...    Config ID: Config_prod_VE
    ...    Applicability: 
    ...    Post-Conditions: 
...
PATCH Scale to level VNFInstance - Method not implemented
    ...
    ...    Test objective: The objective is to verify that the method is not implemented
    ...    Pre-conditions:  
    ...    Reference: clause 5.4.6.3.4 - SOL002 v2.4.1
    ...    Config ID: Config_prod_VE
    ...    Applicability: 
    ...    Post-Conditions: 
...
DELETE Scale to level VNFInstance - Method not implemented
    ...
    ...    Test objective: The objective is to verify that the method is not implemented
    ...    Pre-conditions:  
    ...    Reference: clause 5.4.6.3.5 - SOL002 v2.4.1
    ...    Config ID: Config_prod_VE
    ...    Applicability: 
    ...    Post-Conditions: 
