...
POST Rollback operation task  
    ...
    ...    Reference: clause 5.4.15.3.1 - SOL002 v2.4.1
...
GET Rollback operation task - Method not implemented
    ...
    ...    Pre-conditions: none
    ...    Reference: clause 5.4.15.3.2 - SOL002 v2.4.1
    ...    Config ID: Config_prod_VE
    ...    Applicability: none
    ...    Post-Conditions: 
...
PUT Rollback operation task - Method not implemented
    ...
    ...    Test objective: The objective is to verify that the method is not implemented 
    ...    Pre-conditions: none
    ...    Reference: clause 5.4.15.3.3 - SOL002 v2.4.1
    ...    Config ID: Config_prod_VE
    ...    Applicability: none
    ...    Post-Conditions: 
...
PATCH Rollback operation task - Method not implemented
    ...
    ...    Test objective: The objective is to verify that the method is not implemented 
    ...    Pre-conditions: none
    ...    Reference: clause 5.4.15.3.4 - SOL002 v2.4.1
    ...    Config ID: Config_prod_VE
    ...    Applicability: none
    ...    Post-Conditions: 
...
DELETE Rollback operation task - Method not implemented
    ...
    ...    Test objective: The objective is to verify that the method is not implemented 
    ...    Pre-conditions: none
    ...    Reference: clause 5.4.15.3.5 - SOL002 v2.4.1
    ...    Config ID: Config_prod_VE
    ...    Applicability: none
    ...    Post-Conditions: 
