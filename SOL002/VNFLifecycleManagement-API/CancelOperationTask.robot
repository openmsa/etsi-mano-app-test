...
Post Cancel operation task
    ...
    ...    Reference: clause 5.4.17.3.1 - SOL002 v2.4.1
...
GET Cancel operation task - Method not implemented
    ...
    ...    Pre-conditions: none
    ...    Reference: clause 5.4.17.3.2 - SOL002 v2.4.1
    ...    Config ID: Config_prod_VE
    ...    Applicability: none
    ...    Post-Conditions: none 
...
PATCH Cancel operation task - Method not implemented
    ...
    ...    Pre-conditions: none
    ...    Reference: clause 5.4.17.3.3 - SOL002 v2.4.1
    ...    Config ID: Config_prod_VE
    ...    Applicability: none
    ...    Post-Conditions: none 
...
DELETE Cancel operation task - Method not implemented
    ...
    ...    Pre-conditions: none
    ...    Reference: clause 5.4.17.3.4 - SOL002 v2.4.1
    ...    Config ID: Config_prod_VE
    ...    Applicability: none
    ...    Post-Conditions: none 
