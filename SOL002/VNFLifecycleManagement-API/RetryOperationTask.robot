...
POST Retry operation task  
    ...
    ...    Reference: clause 5.4.14.3.1 - SOL002 v2.4.1
...
GET Retry operation task - Method not implemented
    ...
    ...    Pre-conditions: none
    ...    Reference: clause 5.4.9.14.2 - SOL002 v2.4.1
    ...    Config ID: Config_prod_VE
    ...    Applicability: none
    ...    Post-Conditions: 
    Get Retry operation
...
PUT Retry operation task - Method not implemented
    ...
    ...    Test objective: The objective is to verify that the method is not implemented 
    ...    Pre-conditions: none
    ...    Reference: clause 5.4.9.14.3 - SOL002 v2.4.1
    ...    Config ID: Config_prod_VE
    ...    Applicability: none
    ...    Post-Conditions: 
    Put Retry operation
...
PATCH Retry operation task - Method not implemented
    ...
    ...    Test objective: The objective is to verify that the method is not implemented 
    ...    Pre-conditions: none
    ...    Reference: clause 5.4.9.14.4 - SOL002 v2.4.1
    ...    Config ID: Config_prod_VE
    ...    Applicability: none
    ...    Post-Conditions: 
...
DELETE Retry operation task - Method not implemented
    ...
    ...    Test objective: The objective is to verify that the method is not implemented 
    ...    Pre-conditions: none
    ...    Reference: clause 5.4.9.14.5 - SOL002 v2.4.1
    ...    Config ID: Config_prod_VE
    ...    Applicability: none
    ...    Post-Conditions: 
