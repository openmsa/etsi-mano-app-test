...
POST Individual Subscription - Method not implemented
    ...
    ...    Pre-conditions: none
    ...    Reference: clause 5.4.19.3.1 - SOL002 v2.4.1
...
GET Individual Subscription
    ...
    ...    Pre-conditions: none
    ...    Reference: clause 5.4.19.3.2 - SOL002 v2.4.1
    ...    Config ID: Config_prod_VE
    ...    Applicability: none
    ...    Post-Conditions: none 
    Get Individual Subscription
...
PUT an individual subscription - Method not implemented
    ...
    ...    Test objective: The objective is to test that the method is not implemented
    ...    Pre-conditions: none
    ...    Reference: clause 5.4.19.3.3 - SOL002 v2.4.1
    ...    Config ID: Config_prod_VE
    ...    Applicability: none
    ...    Post-Conditions: none 
...
PATCH an individual subscription - Method not implemented
    ...
    ...    Test objective: The objective is to test that the method is not implemented
    ...    Pre-conditions: none
    ...    Reference: clause 5.4.19.3.4 - SOL002 v2.4.1
    ...    Config ID: Config_prod_VE
    ...    Applicability: none
    ...    Post-Conditions: none 
...
DELETE an individual subscription
    ...
    ...    Test objective: The objective is to test that the method is not implemented
    ...    Pre-conditions: none
    ...    Reference: clause 5.4.19.3.5 - SOL002 v2.4.1
    ...    Config ID: Config_prod_VE
    ...    Applicability: none
    ...    Post-Conditions: none 
