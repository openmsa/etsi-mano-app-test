...
POST Create a new vnfInstance
    ...
    ...    Pre-conditions: 
    ...    Reference: clause 5.4.2.3.1 - SOL002 v2.4.1
...
GET information about multiple VNF instances  
    ...
    ...    Pre-conditions: 
    ...    Reference: clause 5.4.2.3.2 - SOL002 v2.4.1
    ...    Config ID: Config_prod_VE
    ...    Applicability: 
    ...    Post-Conditions: 
...
PUT VNFInstances - Method not implemented
    ...
    ...    Pre-conditions:  
    ...    Reference: clause 5.4.2.3.3 - SOL002 v2.4.1
    ...    Config ID: Config_prod_VE
    ...    Applicability: 
    ...    Post-Conditions: 
...
PATCH VNFInstances - Method not implemented
    ...
    ...    Pre-conditions:  
    ...    Reference: clause 5.4.2.3.4 - SOL002 v2.4.1
    ...    Config ID: Config_prod_VE
    ...    Applicability: 
    ...    Post-Conditions: 
...
DELETE VNFInstances - Method not implemented
    ...
    ...    Test objective: The objective is to test that PUT method is not implemented
    ...    Pre-conditions:  
    ...    Reference: clause 5.4.2.3.5 - SOL002 v2.4.1
    ...    Config ID: Config_prod_VE
    ...    Applicability: 
